...
class CourseSyncUseCaseTest {
    ...
    @Test
    @DisplayName("이미 존재하는 강의는 생성할 수 없다")
    void createCourse_alreadyExists() {
        ...
        assertThatThrownBy(() -> courseSyncService.createCourse(command))
                .isInstanceOf(BusinessException.class)
                .extracting("errorCode")
                .isEqualTo(ErrorCode.COURSE_ALREADY_EXISTS);
    }
    ...
    void deleteCourse_success() {
        ...
        courseSyncService.deleteCourse("course-1");
    ...
    void deleteCourse_notFound() {
        ...
        assertThatThrownBy(() -> courseSyncService.deleteCourse("course-1"))
                .isInstanceOf(BusinessException.class)
                .extracting("errorCode")
